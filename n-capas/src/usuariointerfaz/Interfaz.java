...
public class Interfaz {
	...
	private static void validar()
	{
		...
		System.out.println("El nombre del contacto debe tener máximo 10 caracteres");
		System.out.println("El celular contiene 8 digitos");
		datos.Contacto contacto = new Contacto();
		...
		if(libro.add(contacto)==true)
		{
			...
			System.out.println("Si desea agregar un contacto elija opción 1");
		}
		imprimirMenu();
	}
